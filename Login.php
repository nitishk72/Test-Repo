<?php
    ...
    if(isset($_SESSION["loggedin"])){
        header("Location: http://127.0.0.1/Hack/Profile");
        die();
    }
?>
<!DOCTYPE html>
            ...
            <div class="col-6">
                <form action="./login_submit" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="login_email" id="email" aria-describedby="emailHelp" placeholder="Enter email">
                    </div>
                    <div class="form-group">
